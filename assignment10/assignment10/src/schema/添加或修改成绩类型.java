...
public class 添加或修改成绩类型  implements java.io.Serializable {
    ...
    /**
     * Gets the 学号 value for this 添加或修改成绩类型.
     * 
     * @return 学号
     */
    ...
    /**
     * Sets the 学号 value for this 添加或修改成绩类型.
     * 
     * @param 学号
     */
    ...
    /**
     * Gets the 得分 value for this 添加或修改成绩类型.
     * 
     * @return 得分
     */
    public int get得分() {
    ...
    /**
     * Sets the 得分 value for this 添加或修改成绩类型.
     * 
     * @param 得分
     */
    ...
    /**
     * Gets the 课程编号 value for this 添加或修改成绩类型.
     * 
     * @return 课程编号
     */
    ...
    /**
     * Sets the 课程编号 value for this 添加或修改成绩类型.
     * 
     * @param 课程编号
     */
    ...
    /**
     * Gets the 成绩性质 value for this 添加或修改成绩类型.
     * 
     * @return 成绩性质
     */
    ...
    /**
     * Sets the 成绩性质 value for this 添加或修改成绩类型.
     * 
     * @param 成绩性质
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof 添加或修改成绩类型)) return false;
        添加或修改成绩类型 other = (添加或修改成绩类型) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(添加或修改成绩类型.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://jw.nju.edu.cn/schema", "添加或修改成绩类型"));
