...
public class InitUtil {
    ...
    static {
        ...
        list.add(new Course(11,"离散数学",90));
        list.add(new Course(17,"微积分",96));
        list.add(new Course(8,"计算机组织系统",99));
        list.add(new Course(10,"计算机网络",100));
        ...
        list2.add(new Course(11,"离散数学",100));
        list2.add(new Course(17,"微积分",91));
        list2.add(new Course(8,"计算机组织系统",99));
        list2.add(new Course(10,"计算机网络",100));
        ...
        list3.add(new Course(11,"离散数学",100));
        list3.add(new Course(17,"微积分",92));
        list3.add(new Course(8,"计算机组织系统",99));
        list3.add(new Course(10,"计算机网络",100));
        ...
        list4.add(new Course(11,"离散数学",100));
        list4.add(new Course(17,"微积分",92));
        list4.add(new Course(8,"计算机组织系统",99));
        list4.add(new Course(10,"计算机网络",100));
